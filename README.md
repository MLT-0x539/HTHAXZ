...
### Additional notes:
- Some of the attack vectors (primarily "destructive" attacks such as different forms of DoS) have been commented out so that any pentesters or bug bounty hunters using this file don't crash the webserver. If you want to test for these attacks, then simply uncomment them.
